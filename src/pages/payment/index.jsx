    ...
    <div className="text-center container">
      ...
      <div className="row">
          ...
          <div className="body__content">
            <div>
              ...
              <div style={{ display: "flex" }} className="info__detail">
                ...
                <object className="info__detail--value">{data.map((item) => item.name)}</object>
              </div>
              <hr className="dropdown-divider" />
              <div style={{ display: "flex" }} className="info__detail">
                <object style={{ flex: "1" }} className="info__detail--title">
              ...
              <div style={{ display: "flex" }} className="info__detail">
                ...
                <object className="info__detail--value">
                  {state.seat.split(",").length} pieces
                </object>
              </div>
            </div>
            <hr className="dropdown-divider" />
        ...
        <div className="col-md-8 button">
          <button onClick={handleBack} className="button1">
            Change your movie
          </button>
          <button onClick={() => handleCard()} className="button2">
            Checkout now
          </button>
        </div>
        <Footer />
